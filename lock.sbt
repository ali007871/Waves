...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.typesafe.akka" % "akka-parsing_2.12" % "10.0.7",
  ...
  "io.kamon" % "kamon-akka-2.4_2.12" % "0.6.7",
  "io.kamon" % "kamon-core_2.12" % "0.6.7",
  "io.kamon" % "kamon-log-reporter_2.12" % "0.6.7",
  "io.kamon" % "kamon-scala_2.12" % "0.6.7",
  "io.kamon" % "kamon-statsd_2.12" % "0.6.7",
  "io.kamon" % "kamon-system-metrics_2.12" % "0.6.7",
  "io.kamon" % "sigar-loader" % "1.6.5-rev002",
  "io.netty" % "netty-buffer" % "4.0.46.Final",
  "io.netty" % "netty-codec" % "4.0.46.Final",
  "io.netty" % "netty-codec-http" % "4.0.46.Final",
  "io.netty" % "netty-common" % "4.0.46.Final",
  "io.netty" % "netty-handler" % "4.0.46.Final",
  "io.netty" % "netty-transport" % "4.0.46.Final",
  "io.netty" % "netty-transport-native-epoll" % "4.0.46.Final",
  ...
  "jline" % "jline" % "2.14.1",
  "net.databinder.dispatch" % "dispatch-core_2.12" % "0.13.0",
...
// LIBRARY_DEPENDENCIES_HASH ed92a708418af9e25c6e63aab16d41839ec6c7c8
